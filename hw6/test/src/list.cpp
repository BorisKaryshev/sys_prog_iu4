...
TEST(CustomListTest, PushPopSingle) {
    ...
    int v = 7;
    push_back(&list, reinterpret_cast<const char*>(&v), sizeof(v));

    int out = 0;
    pop_back(&list, reinterpret_cast<char*>(&out), sizeof(out));
...
TEST(CustomListTest, PushPopMultiple) {
    ...
    int a = 1, b = 2, c = 3;
    push_back(&list, reinterpret_cast<const char*>(&a), sizeof(a));
    push_back(&list, reinterpret_cast<const char*>(&b), sizeof(b));
    push_back(&list, reinterpret_cast<const char*>(&c), sizeof(c));

    int x = 0;
    pop_back(&list, reinterpret_cast<char*>(&x), sizeof(x));
    ASSERT_EQ(x, 3);
